...
#print(mat0)
mfig = pyplot.figure(1,figsize=(4,3))
mplt = mfig.add_subplot(111)

mplt.scatter(mat[0,:], mat[9,:]/0.000003003, c= 'cyan', cmap = 'viridis', s=(mat[10,:]/0.000003003)*4000, edgecolor = 'k')
mplt.scatter(mat[0,:], mat[9,:]/0.000003003, c= 'k', s=(mat[9,:]/0.000003003)*200, edgecolor='none' )
